            ...
            <section id={_.get(section, 'section_id', null)} className={classNames('block', 'block-grid', 'outer', {'has-header': _.get(section, 'title', null) || _.get(section, 'subtitle', null)})}>
              <div className="inner">
                ...
                <div className="block-content sdf">
                  <div className={classNames('grid', {'grid-col-4': _.get(section, 'col_number', null) === 'four', 'grid-col-3': _.get(section, 'col_number', null) === 'three','grid-col-4': _.get(section, 'col_number', null) === 'four'})}>
