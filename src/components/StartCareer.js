...
export default class StartCareer extends React.Component {
    render() {
        ...
        console.log(section)
        return (
            <section id={_.get(section, 'section_id', null)} className= {classNames('block', 'start-career', 'block-grid', 'outer',{_.get(section, 'section_id', null)}, {'has-header': _.get(section, 'title', null) || _.get(section, 'subtitle', null)})}>
              {/* <div className="inner"> */}
